...
using System.IO;
using TouhouChaos.NPCs.Bosses;
using TouhouChaos.Items;
...
namespace TouhouChaos
{
    public class TouHouChaos : Mod
    {
        ...
        {
            Mod mod = JoostMod.instance;
            player.QuickSpawnItem(mod.ItemType("StormWyvernScroll"));
        ...
        public void DrawEmptyHeart(SpriteBatch spriteBatch)
        {
            ...
            if (player.GetModPlayer<BloodyKillPlayer>().emptyHeart)
            {
        ...
        class SpawnRateMultiplierGlobalNPC : GlobalNPC
        {
            ...
            {
                if (player.GetModPlayer<BloodyKillPlayer>().HavocPendant)
                {
